<template>
    <MainLayout>
        <div class="app-container">
            ...
            <h3 class="mb-4">GENERAL TERMS AND CONDITIONS FOR SALE OF PRODUCTS AND SERVICES</h3>
            <strong class="mb-3 d-inline-block">Definitions & Interpretation</strong>
            ...
            <strong class="mb-3 d-inline-block">General</strong>
            ...
            <strong class="mb-3 d-inline-block">Quotations</strong>
            ...
            <strong class="mb-3 d-inline-block">Prices / Taxes</strong>
            ...
            <strong class="mb-3 d-inline-block">Terms of Payment</strong>
            <p>Credit Card Payments may attract a surcharge, and Shop will inform the Customer if this is to be the case before processing the transaction.<br>Unless otherwise agreed in writing by Shop, where Shop has not agreed in writing to provide commercial credit to the Customer, the total purchase price for Products supplied will be due for payment in cash prior to delivery.<br>Where Shop has agreed in writing to provide commercial credit to the Customer, the Customer must make payments in accordance with the payment terms provided by Shop.<br>Where Shop has approved the provision of a commercial credit arrangement with the Customer but has not provided notice of the payment terms to the Customer, the Customer must pay the total purchase price for Products supplied within seven days of the statement date.<br>Credit Card Payment at an Invoice or transaction level may also be offered to the Customer as a stand-alone payment method, or in conjunction with Credit Card Direct Debit Authorisation.</p>
            <strong class="mb-3 d-inline-block">Credit Accounts</strong>
